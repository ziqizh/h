...
def configure(environ=None, settings=None):
    ...
    settings_manager.set('secret_key', 'SECRET_KEY', type_=_to_uft8, required=True)
    settings_manager.set('secret_salt', 'SECRET_SALT', type_=_to_uft8, default=DEFAULT_SALT)
